...
public class AudioControl : MonoBehaviour {
    ...
    {
        PlayInPosition(CORE.Instance.AudioDatabase[gClip], pos, MaxDistance);
    }


    public void PlayInPosition(AudioClip gClip, Vector3 pos, float MaxDistance = 47f)
    {
        ...
        {
            currentInstance = (GameObject)Instantiate(CORE.Instance.PrefabDatabase[m_sInstancePrefab]);
        ...
        currentInstance.GetComponent<AudioSource>().clip = gClip;
    ...
    public void Play(string gClip)
    {
        ...
        currentInstance.GetComponent<AudioSource>().pitch = 1f;
        currentInstance.GetComponent<AudioSource>().clip = CORE.Instance.AudioDatabase[gClip];
        currentInstance.GetComponent<AudioSource>().Play();
