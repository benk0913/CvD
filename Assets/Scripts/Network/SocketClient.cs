...
public class SocketClient : MonoBehaviour
{
    ...
    protected void OnMovement(Socket socket, Packet packet, params object[] args)
    {
        ...
        //BroadcastEvent("Movement occured - "+data["id"]);
    ...
    public void SendWorldDMG(int damage)
    {
        JSONNode node = new JSONClass();
    ...
    public void SendMobsMove()
    {
        ...
        //Func was demolished, copy from lul if you wqant the original
    ...
    public void SendItemPositions(List<Vector3> ItemInstances)
    {
        ...
        {
            node["items"][i]["x"] = ItemInstances[i].x.ToString();
            node["items"][i]["y"] = ItemInstances[i].y.ToString();

            node["items"][i]["item_id"] = "WAW";
        }
